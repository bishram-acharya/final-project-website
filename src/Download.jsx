  ...
  return (
    <section className="resources" id="resources">
      ...
      <p className="resources-subtitle">
        Access key documents to learn more about our Project:
      </p>
      <div className="resources-container">
        ...
        <strong>The Downloadable Resources will only be made available after the completion of the Project.</strong>
      </div>
    </section>
  );
};
